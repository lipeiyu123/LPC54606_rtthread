...
uint8 image_bin[OV7725_H][OV7725_DMA_NUM];                                   //定义存储接收图像的数组
...
void ov7725_port_init(void)
{
    ...
    dam_init(OV7725_DMA_CH, (void *)&OV7725_DATAPORT, (void *)image_bin[0], OV7725_DMA_NUM);
...
void ov7725_vsync(void)
{
    ...
    dma_reload(OV7725_DMA_CH, (void *)&OV7725_DATAPORT, (void *)image_bin[0], OV7725_DMA_NUM);
...
void ov7725_dma(void)
{
    ...
    if((OV7725_H) > ov7725_now_num)
    {
        dma_reload(OV7725_DMA_CH, (void *)&OV7725_DATAPORT, (void *)image_bin[ov7725_now_num], OV7725_DMA_NUM);
        DMA_ENABLE(OV7725_DMA_CH);
    }
    else    ov7725_finish_flag = 1;		//采集完成标志位
