...
void iic_mux(IICN_enum iic_n, IIC_PIN_enum sda_pin, IIC_PIN_enum scl_pin)
{
    switch(iic_n)
    {
        ...
        case IIC_5:
        {
            ...
            if     (IIC4_SCL_A9  == scl_pin)    iocon_init(A9 ,ALT3 | DIGITAL | FILTEROFF | PULLUP | OD);
        ...
        case IIC_7:
        {
            ...
            else if(IIC6_SDA_B21 == sda_pin)    iocon_init(B21,ALT1 | DIGITAL | FILTEROFF | PULLUP | OD);
            else if(IIC6_SDA_B29 == sda_pin)    iocon_init(B29,ALT1 | DIGITAL | FILTEROFF | PULLUP | OD);
            else                                ASSERT(0);//引脚错误 进入断言失败                  
